...
export const REG_REQUEST_ERROR: 'REG_REQUEST_FAIL' = 'REG_REQUEST_FAIL';
export const REG_ERROR_RESET: 'REG_ERROR_RESET' = 'REG_ERROR_RESET';
export const LOGIN_REQUEST_SUBMIT: 'LOGIN_REQUEST_SUBMIT' = 'LOGIN_REQUEST_SUBMIT';
export const LOGIN_REQUEST_SUCCESS: 'LOGIN_REQUEST_SUCCESS' = 'LOGIN_REQUEST_SUCCESS';
export const SET_LOGGEDIN: 'SET_LOGGEDIN' = 'SET_LOGGEDIN';
export const LOGIN_REQUEST_REJECTED: 'LOGIN_REQUEST_REJECTED' = 'LOGIN_REQUEST_REJECTED';
export const LOGIN_REJECTION_RESET: 'LOGIN_REJECTION_RESET' = 'LOGIN_REJECTION_RESET';
