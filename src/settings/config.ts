...
export const pathAuthToken = '/api/auth/token';
export const pathAuthUser = '/api/auth/user';
export const pathInitPasswordReset = '/api/password-reset'
export const pathSubmitNewPassword = '/api/password-reset/reset'

export const cookieMaxAgeDays = 1;
